defmodule Tictac.State do
    ...
    defstruct status: :initial, # Possible: :initial, :choose_p1, :playing, :game_over, :winner_reported
            turn: nil,
            winner: nil,
    ...
    def event(%State{status: playing, turn: p} = state, {:play, p}) when p not in @players do
